...
// Red triangles underwater from the surface to bottom, along the right side of the screen.
 
 void triangle() {   

fill (255,0,0);
triangle (393, 84, 393, 127, 378, 107);
fill (255,0,0);
triangle (392, 91, 391, 158, 363, 126);
fill (255,0,0);
triangle (388 , 209, 388, 260, 355, 236);
fill (255, 0, 0);
triangle (394, 267, 392, 306, 366, 284);
